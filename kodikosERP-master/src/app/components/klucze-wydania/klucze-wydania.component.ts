...
@Component({
  selector: 'app-klucze-wydania',
  templateUrl: './klucze-wydania.component.html',
  styleUrls: ['./klucze-wydania.component.scss']
})
export class KluczeWydaniaComponent implements OnInit, OnDestroy {
